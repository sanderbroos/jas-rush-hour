...
class Manual:
    ...
    def run(self):
        ...
        """
        print("Instructions: Left and down are negative numbers,",
                "right and up are positive numbers\nExecute ",
                "\'python3 main.py < docs/output.csv\' to watch a solution ",
                "being played (choose the right game first in the code).", sep='')
        ...
        while not self.game.won():
            ...
            if not self.game.move(move[0].upper(), int(move[1])):
